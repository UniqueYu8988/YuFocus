...
contextBridge.exposeInMainWorld('desktopAPI', {
  ...
  testEmailPush: () => ipcRenderer.invoke('email:test'),
  ...
  summarizeMaterialPackage: (payload: { materialPath: string; editorialMode?: 'auto' | 'force' | 'off' }) => ipcRenderer.invoke('materials:summarize', payload),
