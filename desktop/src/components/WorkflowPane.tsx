...
const workflowDocuments: Array<{
...
}> = [
  {
    key: 'project_context',
    label: '查看项目语境',
    description: '长期方向、队列规则、产品边界',
    icon: <BookOpen size={14} />,
  },
  {
    key: 'editorial_pipeline',
    label: '查看编稿流程',
    description: '短视频 API 编稿路线与产物',
    icon: <Route size={14} />,
  },
  {
    key: 'system_optimization_audit',
    label: '查看系统审计',
    description: '文件边界、轻量结构与效率指标',
    icon: <GitBranch size={14} />,
  },
  {
    key: 'cleanup_baseline',
    label: '查看清理基线',
    description: '当前主线、兼容层与旧路线删除边界',
    icon: <Archive size={14} />,
  },
  {
    key: 'email_contract',
    label: '查看邮件合同检查',
    description: '标题、删减板块、邮件兼容回归',
    icon: <ShieldCheck size={14} />,
  },
  {
    key: 'distiller_core',
    label: '查看 distiller 核心逻辑',
    description: '字幕清洗、编稿和 HTML 生成主入口',
