...
// Compatibility tree utilities for the 专注 reader. The active production
// pipeline writes source records and article materials, then adapts them into
// this historical shape only so the existing reader can stay usable.
