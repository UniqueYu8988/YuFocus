...
import { makeCoachMessages, makeMessage } from '../legacy/learning/coachMessages'
import { getNextNodeId, getNextSequentialNodeId, getUnlockedNodeIds, isStudyNode } from '../legacy/learning/studyTree'
import {
  ...
  persistSession,
} from '../legacy/learning/learningState'
import { buildCompletionCelebrationPayload } from '../legacy/learning/learningProgression'
import {
  buildDistillProgressSnapshot,
  type DistillProgressSnapshot,
} from '../domain/pipeline/distillProgress'
import { buildFallbackCoachTurn, resolveTrackedQuestion } from '../legacy/learning/learningTurn'
import type {
  AchievementBadge,
  CoachMessage,
  CoursePackage,
