...
AUDIO_MAX_CHUNK_SECONDS = max(
    120.0,
    float(os.getenv("ONBOARD_AUDIO_MAX_CHUNK_SECONDS", "480") or "480"),
)
...
AUDIO_TRANSCRIBE_WORKERS = max(
    1,
    int(os.getenv("ONBOARD_AUDIO_TRANSCRIBE_WORKERS", "3") or "3"),
)
AUDIO_CHUNK_WORKERS = max(
    1,
    int(os.getenv("ONBOARD_AUDIO_CHUNK_WORKERS", "3") or "3"),
)
...
TRANSCRIPT_SEGMENT_TARGET_CHARS = max(
    40,
    int(os.getenv("ONBOARD_TRANSCRIPT_SEGMENT_TARGET_CHARS", "90") or "90"),
)
TRANSCRIPT_SEGMENT_MAX_CHARS = max(
    TRANSCRIPT_SEGMENT_TARGET_CHARS,
    int(os.getenv("ONBOARD_TRANSCRIPT_SEGMENT_MAX_CHARS", "120") or "120"),
)
